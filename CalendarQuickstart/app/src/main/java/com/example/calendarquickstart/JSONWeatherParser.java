...
package com.example.calendarquickstart;
        ...
        import com.example.calendarquickstart.DayForecast;
        import com.example.calendarquickstart.Location;
        import com.example.calendarquickstart.Weather;
        import com.example.calendarquickstart.WeatherForecast;
...
public class JSONWeatherParser {
    ...
    public static WeatherForecast getForecastWeather(String data) throws JSONException  {
        ...
        JSONObject jCity = jObj.getJSONObject("city"); // get city name
        forecast.setLocation(jCity.getString("name"), jCity.getString("country"));
